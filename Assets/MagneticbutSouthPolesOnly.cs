...
public class MagneticbutSouthPolesOnly : MonoBehaviour
{
    /// <summary>
    ...
    [SerializeField]
    GameObject southPole, theOtherSouthPole;
    ...
    void Start()
    {
        ...
        vec_array[1] = southPole.transform.position;
        vec_array[2] = theOtherSouthPole.transform.position;
